import { Actions, Conversation, Header, Image, Text, Video } from "@components/StoryComponent/components";
                ...
                >
                    {displayable.components.map((component, index) => {
                        switch (component.type) {
                            case "header":
                                return <Header key={index} component={component} />;
                            ...
                            case "video":
                                return <Video key={index} component={component} />;

                            case "actions":
                                return <Actions key={index} component={component} />;

                            case "conversation":
                                return <Conversation key={index} component={component} />;
