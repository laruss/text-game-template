...
import {
    ActionsComponent, AnotherStoryComponent,
    ComponentCallback, ConversationBubble, ConversationComponent,
    HeaderComponent,
    ImageComponent,
    StoryOptions,
    TextComponent,
...
): OptionalCallable<ActionsComponent> => () => callIfFunction(component);

export const newLine = (bubble: ConversationBubble): ConversationBubble =>
    bubble;

export const newConversation = (
    component: MaybeOptionalCallable<ConversationComponent> | ConversationComponent['content']
